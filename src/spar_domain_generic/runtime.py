"""Generic adapter runtime entry point for the SPAR framework."""
...
from .registry_seed import generic_gap_registry_snapshot, generic_model_registry_snapshot
...
def get_review_runtime() -> ReviewRuntime:
    return ReviewRuntime(
        ...
        build_model_registry_snapshot=generic_model_registry_snapshot,
        build_gap_registry_snapshot=generic_gap_registry_snapshot,
