"""Math adapter runtime entry point for the SPAR framework."""
...
from .registry_seed import math_gap_registry_snapshot, math_model_registry_snapshot
...
def get_review_runtime() -> ReviewRuntime:
    return ReviewRuntime(
        ...
        build_model_registry_snapshot=math_model_registry_snapshot,
        build_gap_registry_snapshot=math_gap_registry_snapshot,
